...
class _RepositoryTabState extends State<RepositoryTab> {
  ...
  @override
  void initState() {
    Provider.of<RepositoryProvider>(context, listen: false).searchUser(widget.name).then((value) => null);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder(
        future: Provider.of<RepositoryProvider>(context, listen: false).searchUser(widget.name),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  Text("${data.data.repository.length} repositories found ",
